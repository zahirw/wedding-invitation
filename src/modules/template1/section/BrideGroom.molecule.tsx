  ...
  return (
    <div className="w-full pt-20">
      ...
      <p
        className={cn(
          LTRemark.className,
          "text-4xl text-[#FEFAE0] text-center pt-16 mt-1"
        )}
      >
        The Groom
      </p>{" "}
      <div className="relative">
        <Image
          src={"/assets/groom-photo.png"}
          className="w-full h-full"
          alt="bride"
          width={430}
          height={650}
        />
        <span className="absolute top-0 w-full h-full bg-gradient-to-b from-transparent from-45% to-[#A6B37D]" />
        <div className="absolute bottom-0 w-full h-auto px-10 flex flex-col z-10">
          <p className={cn(LTRemark.className, "text-xl text-white underline")}>
            Monkey D. Asep, S.kom
          </p>
